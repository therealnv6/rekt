...
interface DataStream
{
     ...
     */
    suspend fun publish(connection: RedisConnection, message: String, channel: String)
     ...
     */
    suspend fun subscribe(connection: RedisConnection, subscriber: Subscriber, vararg channel: String)
     ...
     */
    suspend fun pSubscribe(connection: RedisConnection, subscriber: Subscriber, vararg pattern: String)
}